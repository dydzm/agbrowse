...
| `skills/browser/` | 23 | 6560 | Chrome lifecycle, CDP connection, refs, tabs, diagnostics |
...
| `test/unit/` | 84 | 7960 | deterministic module tests |
| `test/integration/` | 16 | 1823 | CLI, MCP, policy, provider fixture tests |
...
| `devlog/` | 241 | 27597 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3085 | root CLI parser, Chrome lifecycle, browser primitive commands |
