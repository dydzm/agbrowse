...
| `web-ai/` | 93 | 20675 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 100 | 11476 | deterministic module tests |
...
| `devlog/` | 338 | 41746 | phased plan, research, implementation notes (incl. strict-migration phases) |
...
| `web-ai/cli.mjs` | 1637 | `web-ai` subcommand parser and command orchestration |
