...
| [35_session_reattach_followup_pabcd.md](35_session_reattach_followup_pabcd.md) | Sidebar 대화 검색-열기 + Deep Research reattach PABCD 계획 (04 구체화) | **P1** |
...
| 35 session reattach | 📋 impl-ready | sidebar 검색-열기 + DR reattach; 04 구체화 |

**즉시 구현 착수 가능 backlog (P0–P2, PABCD impl-ready)**: 31(P0 generic file lane) · 32.1(P0 DR capture) · 32.3(P1 session guard) · 32.2(P1 model picker, 감사 완료) · **33**(P1 dual-path 캡처) · **35**(P1 sidebar/DR reattach) · **34**(P2 diagnostics).
