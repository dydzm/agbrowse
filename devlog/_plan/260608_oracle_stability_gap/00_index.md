...
| 35 session reattach | 📋 impl-ready | new-tab 복구 + DR reattach; 04 구체화 (35.1 new-tab 개정) |

**구현 시퀀스 ([36](36_implementation_master_plan.md) §3, 실행 중)**: 31(P0 generic files) → 32.1(P0 DR capture) → 32.3(P1 session guard) → 32.2(P1 model picker) → **35**(P1 new-tab/DR reattach) → **33**(P1 dual-path, 마지막) → **34**(P2 diagnostics).
